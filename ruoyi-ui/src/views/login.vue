      ...
      <div class="login-form-box">
        ...
        <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form">
          ...
          <el-form-item prop="code" v-if="captchaEnabled">
            <el-input v-model="loginForm.code" auto-complete="off" placeholder="请输入右侧二维码" style="width: 53%"
              @keyup.enter.native="handleLogin">
          ...
          <el-form-item style="width:100%;">
            <el-button :loading="loading" size="medium" type="primary" style="width:85%;"
...
.login {
  ...
  align-items: center;
  height: 100%;
  background-image: url("../assets/images/wuxi.jpg");
